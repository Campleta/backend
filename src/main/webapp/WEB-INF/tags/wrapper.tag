        ...
        <nav class="navbar navbar-fixed-top">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/">Campleta</a>
                </div>

                <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <!--<ul class="nav navbar-nav">
                      <li routerLink="/products" routerLinkActive="active"><a href="#">Products <span class="sr-only">(current)</span></a></li>
                      <li routerLink="/prices" routerLinkActive="active"><a href="#">Prices</a></li>
                      <li routerLink="/cases" routerLinkActive="active"><a href="#">Cases</a></li>
                    </ul>-->
